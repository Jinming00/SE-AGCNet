"""Metric discriminator for speech quality assessment."""
...
def batch_pesq(clean, noisy):
    """Calculate normalized PESQ scores for batch of audio pairs."""
...
def metric_loss(metric_ref, metrics_gen):
    """Calculate metric discriminator loss."""
    loss = 0
...
class MetricDiscriminator(nn.Module):
    """Metric discriminator for perceptual quality assessment."""
    ...
    def forward(self, x, y):
        """Forward pass with clean and enhanced magnitude spectrograms."""
